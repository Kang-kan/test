...
import { getChargeRank, getServerInfo } from '@/api/user'
export default {
  name: 'ChargeRank',
  components: {
    STable,
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          customRender: rmb => rmb && Math.floor(rmb / 100) + '元'
        },
        {
          title: '服务器id',
          dataIndex: 'serverId',
      ...
      loadData: parameter => {
        ...
        return getChargeRank(Object.assign(parameter, s.queryParam)).then(res => {
