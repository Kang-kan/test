        ...
        <a-row :gutter="0">
          ...
          <a-col :md="6" :sm="12">
            <a-row>
              ...
              <a-col :md="14">
                <a-select size="default" @change="qudaoChange" mode="multiple" placeholder="默认全渠道">
...
import { getDailyOnlineStatis, getServerInfo } from '@/api/user'
  ...
  data() {
    return {
      ...
      loadData: parameter => {
        ...
        return getDailyOnlineStatis(Object.assign(parameter, s.queryParam)).then(res => {
