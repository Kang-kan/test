...
import { getChargeStatis, getServerInfo } from '@/api/user'
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          dataIndex: 'chargeAmout',
          customRender: chargeAmout => (chargeAmout / 100)+ '元'
        },
        {
          title: '当日首充',
          dataIndex: 'todyAmout',
          ...
          customRender: todyAmout => (todyAmout / 100)+ '元'
        }
      ],
      ...
      loadData: parameter => {
        ...
        return getChargeStatis(Object.assign(parameter, s.queryParam)).then(res => {
