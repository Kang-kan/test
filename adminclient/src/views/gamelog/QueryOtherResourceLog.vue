    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="0">
          ...
          <a-col :md="5" :sm="12">
            <a-row>
              <a-col :md="7" style="line-height: 32px;">货币类型:</a-col>
              <a-col :md="14">
                <a-select size="default" mode="multiple" @change="currencyTypeChange">
                  <a-select-option key="25" value="25">竞技积分(0)</a-select-option>
                  <a-select-option key="21" value="21">仙盟贡献(1)</a-select-option>
                  <a-select-option key="34" value="34">商店积分(2)</a-select-option>
                </a-select>
              </a-col>
            </a-row>
          </a-col>
...
<script>
  ...
  import { getOtherResourceLog, getServerInfo } from '@/api/user'
  export default {
    ...
    data() {
      return {
        ...
        loadData: parameter => {
          ...
          return getOtherResourceLog(Object.assign(parameter, s.queryParam)).then(res => {
            ...
            res.contents.forEach(async function(el) {
              ...
              el.type = (await xmlObj.getName(el.type)) + '(' + el.type + ')'
            })
            return res
          })
        },
    ...
    methods: {
      ...
      currencyTypeChange(value) {
        console.log(value)
        this.queryParam.currency = encodeURIComponent(JSON.stringify(value))
      },
