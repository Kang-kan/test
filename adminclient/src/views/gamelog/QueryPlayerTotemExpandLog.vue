...
import { getPlayerTotemExpandLog, getServerInfo } from '@/api/user'
export default {
  ...
  data() {
    return {
      ...
      loadData: parameter => {
        ...
        return getPlayerTotemExpandLog(Object.assign(parameter, s.queryParam)).then(res => {
