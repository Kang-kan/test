    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="0">
          ...
          <a-col :md="5" :sm="12">
            <a-row>
              <a-col :md="7" style="line-height: 32px;">强化类型:</a-col>
              <a-col :md="14">
                <a-select size="default" @change="typeChange">
                  <a-select-option key="-1" value="-1">所有</a-select-option>
                  <a-select-option key="0" value="0">强化</a-select-option>
                  <a-select-option key="1" value="1">精炼</a-select-option>
                  <a-select-option key="2" value="2">灵石</a-select-option>
                </a-select>
              </a-col>
            </a-row>
          </a-col>
...
<script>
  ...
  import { getPlayerEnhanceLog, getServerInfo } from '@/api/user'
  export default {
    ...
    data() {
      return {
        ...
        loadData: parameter => {
          ...
          return getPlayerEnhanceLog(Object.assign(parameter, s.queryParam)).then(res => {
