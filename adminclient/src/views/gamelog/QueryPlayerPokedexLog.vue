...
<script>
  ...
  import { getPokedexLog, getServerInfo } from '@/api/user'
  export default {
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            customRender: opValue => (opValue == 0 ? '激活' : '升级')
          },
          // {
          //   title: '平台',
          //   dataIndex: 'platName',
        ...
        loadData: parameter => {
          ...
          return getPokedexLog(Object.assign(parameter, s.queryParam)).then(res => {
