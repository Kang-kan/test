...
import { getPlayerMeridianLog, getServerInfo } from '@/api/user'
export default {
  ...
  data() {
    return {
      ...
      loadData: parameter => {
        ...
        return getPlayerMeridianLog(Object.assign(parameter, s.queryParam)).then(res => {
