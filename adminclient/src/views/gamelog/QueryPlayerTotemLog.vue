...
import { getPlayerTotemLog, getServerInfo } from '@/api/user'
export default {
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          customRender: opValue => (opValue == 0 ? '激活' : '蕴养')
        },
        {
          title: '英雄下标',
          scopedSlots: {
      ...
      loadData: parameter => {
        ...
        return getPlayerTotemLog(Object.assign(parameter, s.queryParam)).then(res => {
