  ...
  <a-card :body-style="{padding: '24px 32px'}" :bordered="false">
    <a-row>
      <a-col>
        ...
        <div v-html="noticeHtml" style="width: 100%;minHeight: 100px;">
...
<script>
import {getLoginNotice , setLoginNoticer} from '@/api/user'
export default {
  name: 'SetGameNotice',
  data() {
    return {
  ...
  methods: {                    
    ...
    handleSubmit(e) {
      ...
      s.form.validateFields((err, values) => {
        ...
        setLoginNoticer(values).then(res => {
          if(res) {
            s.$message.success('游戏内公告设置成功')
          }
        })
      })
    }
