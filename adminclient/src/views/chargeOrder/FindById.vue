  ...
  <a-card :bordered="false">
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="0">
          <a-col :md="6" :sm="24">
            <a-input placeholder="请输入定单Id" v-model="orderId"/>
          </a-col>
        ...
        <a-row :gutter="0" style="text-align: center;font-size: 18px;font-weight: 500;" v-show="filterBol">
          筛选
        </a-row>
      </a-form>
    </div>

    <a-table ref="table" size="default" rowKey="monthtableid" :columns="columns" :dataSource="tableData" 
...
<script>
  ...
  export default {
    ...
    methods: {
      seach() {
        let s = this;
        s.queryParam.orderId = s.orderId + ''
        //console.log('query============>',s.queryParam)
        getFindOrderById(s.queryParam)
          .then(res => {
