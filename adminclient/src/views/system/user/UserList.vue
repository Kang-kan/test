<template>
  <a-card :bordered="false">
    <div class="table-operator">
      <a-button type="primary" icon="plus" @click="$refs.createModal.add()"></a-button>
    </div>
    ...
    <a-modal title="确认删除该用户" :visible="deletvisible" @ok="handleDelet" @cancel="deletvisible = false">
      <p>{{deletText}}</p>
    </a-modal>
  </a-card>
</template>
...
import DetailModal from './modules/UserDetailModal'
import ChangeModal from './modules/ChangeUserInfo'
import ResetPwdModal from './modules/ResetPwdModal'
import { getUserList , getAccessRight , deleteUser ,resetOtherPassword ,changeOwnPsd ,addUser} from '@/api/manage'
