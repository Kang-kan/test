        ...
        <a-row :gutter="0">
          ...
          <a-col :md="6" :sm="12">
            <a-row>
              ...
              <a-col :md="14">
                <a-select size="default" mode="multiple" @change="qudaoChange" placeholder="默认全渠道">
...
<script>
  ...
  import { getChargeLoginLoss, getServerInfo } from '@/api/user'
  export default {
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            dataIndex: 'lossPlayer',
            customRender: lossPlayer => {
              console.log(this)
              return lossPlayer
            }
          }
        ...
        loadData: parameter => {
          ...
          return getChargeLoginLoss(Object.assign(parameter, s.queryParam)).then(res => {
            ...
            res.contents.forEach(el => {
              el.lossPlayer = `${el.lossPlayer}(${(el.lossPlayer * 100 / el.chargePlayer).toFixed(2)}%)`
            })
