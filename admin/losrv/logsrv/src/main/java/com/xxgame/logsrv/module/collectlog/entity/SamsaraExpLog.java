 ...
 *
 */
@Entity(name = "samsara_exp_log")
@Table(indexes = @Index(name = "playerId_index", columnList = "playerId"))
public class SamsaraExpLog extends BasePlayerLogEntity {
	 ...
	 * 轮回等级
	 */
	@Column(columnDefinition = "INT NOT NULL COMMENT '轮回等级'")
	private int samsaraLevel;
	...
	public int getSamsaraLevel() {
		return samsaraLevel;
	}

	public void setSamsaraLevel(int samsaraLevel) {
		this.samsaraLevel = samsaraLevel;
	}
